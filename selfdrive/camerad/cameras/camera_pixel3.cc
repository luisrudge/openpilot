...
const size_t FRAME_HEIGHT = 3024;
const size_t FRAME_STRIDE = 5056;  // for 10 bit output.
...
void CameraState::config_isp(int io_mem_handle, int fence, int request_id, int buf0_mem_handle, int buf0_offset) {
  ...
  tmp.bw = {
    ...
    .left_pix_vote = {
      .resource_id = 0,
      .cam_bw_bps = 1383803365,
      .ext_bw_bps = 1383803365,
    },
    .right_pix_vote = {
      .resource_id = 0,
      .cam_bw_bps = 1383370170,
      .ext_bw_bps = 1383370170,
    },
    .rdi_vote[0] = {
      .resource_id = 0,
      .cam_bw_bps = 545828880,
      .ext_bw_bps = 545828880,
    },
  };
