...
from openpilot.selfdrive.car.ford.values import CANFD_CAR, CarControllerParams, DBC, FordFlags
...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    # cruise state
    ret.cruiseState.speed = cp.vl["EngBrakeData"]["Veh_V_DsplyCcSet"] * (CV.MPH_TO_MS if self.CP.flags & FordFlags.METRIC_UNITS else CV.KPH_TO_MS)
