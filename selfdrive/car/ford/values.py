...
class CAR(Platforms):
  ...
  ESCAPE_MK4 = FordPlatformConfig(
    "FORD ESCAPE 4TH GEN",
    [
      FordCarInfo("Ford Escape 2020-22", electrification=("ICE", "HEV", "PHEV")),
      FordCarInfo("Ford Kuga 2020-22", "Adaptive Cruise Control with Lane Centering", electrification=("ICE", "HEV", "PHEV")),
    ],
  ...
  EXPLORER_MK6 = FordPlatformConfig(
    ...
    [
      FordCarInfo("Ford Explorer 2020-23", electrification=("ICE", "HEV")),
      FordCarInfo("Lincoln Aviator 2020-23", "Co-Pilot360 Plus", electrification=("ICE", "PHEV")),
    ],
    CarSpecs(mass=2050, wheelbase=3.025, steerRatio=16.8),
  )
  F_150_MK14 = FordCANFDPlatformConfig(
    "FORD F-150 14TH GEN",
    FordCarInfo("Ford F-150 2022-23", "Co-Pilot360 Active 2.0", electrification=("ICE", "HEV")),
    CarSpecs(mass=2000, wheelbase=3.69, steerRatio=17.0),
  )
  F_150_LIGHTNING_MK1 = FordCANFDPlatformConfig(
    "FORD F-150 LIGHTNING 1ST GEN",
    FordCarInfo("Ford F-150 Lightning 2021-23", "Co-Pilot360 Active 2.0", electrification="BEV"),
    CarSpecs(mass=2948, wheelbase=3.70, steerRatio=16.9),
  )
  FOCUS_MK4 = FordPlatformConfig(
    "FORD FOCUS 4TH GEN",
    FordCarInfo("Ford Focus 2018", "Adaptive Cruise Control with Lane Centering", electrification=("ICE", "HEV"), footnotes=[Footnote.FOCUS]),
    CarSpecs(mass=1350, wheelbase=2.7, steerRatio=15.0),
  )
  MAVERICK_MK1 = FordPlatformConfig(
    "FORD MAVERICK 1ST GEN",
    [
      FordCarInfo("Ford Maverick 2022", "LARIAT Luxury", electrification=("ICE", "HEV")),
      FordCarInfo("Ford Maverick 2023-24", "Co-Pilot360 Assist", electrification=("ICE", "HEV")),
    ],
    CarSpecs(mass=1650, wheelbase=3.076, steerRatio=17.0),
  )
  MUSTANG_MACH_E_MK1 = FordCANFDPlatformConfig(
    "FORD MUSTANG MACH-E 1ST GEN",
    FordCarInfo("Ford Mustang Mach-E 2021-23", "Co-Pilot360 Active 2.0", electrification="BEV"),
