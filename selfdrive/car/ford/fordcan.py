def create_lkas_command(packer):
  """
  ...
  return packer.make_can_msg("Lane_Assist_Data1", 0, {})
...
def create_acc_ui_command(packer, main_on: bool, enabled: bool, stock_values):
  ...
  values = {
    **stock_values,
    "Tja_D_Stat": 2 if enabled else (1 if main_on else 0),      # TJA status: 0=Off, 1=Standby, 2=Active,
                                                                # 3=InterventionLeft, 4=InterventionRight,
                                                                # 5=WarningLeft, 6=WarningRight, 7=NotUsed [0|7]
  }
