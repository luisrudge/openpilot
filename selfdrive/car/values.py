...
from openpilot.selfdrive.car.psa.values import CAR as PSA
...
BRANDS = [BODY, CHRYSLER, FORD, GM, HONDA, HYUNDAI, MAZDA, MOCK, NISSAN, PSA, SUBARU, TESLA, TOYOTA, VOLKSWAGEN]
